...
import kotlinx.android.synthetic.main.activity_register_people_rep.*
...
class Register_peopleRep : AppCompatActivity() {

    private lateinit var auth: FirebaseAuth

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_register_people_rep)
    ...
    private  fun  doRegister() {
        ...
        val db = FirebaseFirestore.getInstance().document("PeopleRep/" + email)
